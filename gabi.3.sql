...
BEGIN 
    ...
    OLD.email, 
    OLD.data_nascimento, 
    OLD.rua, OLD.bairro, OLD.cidade, OLD.estado, OLD.estado_sigla, OLD.cargo, OLD.salario);
END
$
DELIMITER ;
